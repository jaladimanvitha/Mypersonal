...
public class ExportManifestController {
	...
	public ResponseEntity<HSSFWorkbook> exportToExcel(@RequestBody ExportManifestIVO request) {
		...
		try {
            ...
            FileMetadata metdata = new FileMetadata();
            HttpSession session;
            MultipartFile files[] = null;
            files[0] = new MultipartFile(filename1,filename1,"application/vnd.ms-excel",workbook);
           //MultiFileUploadController.handleFileUpload(session,files,"exportManifest",metdata);
